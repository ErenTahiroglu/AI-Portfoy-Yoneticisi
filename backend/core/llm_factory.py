...
def get_quick_think_llm(model_name: str = "gemini-2.5-flash", temperature: float = 0.2, max_tokens: int = 500) -> BaseChatModel:
    \"\"\"
...
def get_deep_think_llm(model_name: str = "gemini-2.5-pro", temperature: float = 0.1, max_tokens: int = 1500) -> BaseChatModel:
    \"\"\"
