...
* **v11.2 (Current): Hybrid Redis & Persistence.** Added standard TCP Redis support for local Docker compatibility. Completed Supabase SQL schema with missing telemetry and portfolio tables. Hardened JWT authentication layer and Redis failover logic.
